var database = [
    ...
    {        
        ...
        lyrics:[
            ...
            {time: "00:02", lyric: "歌手： 陈奕迅"},
            {time: "00:03", lyric: "作词： 葛大为"},
            {time: "00:04", lyric: "作曲： 黎晓阳,谢国维"},
            {time: "00:10", lyric: "走过了人来人往"},
            {time: "00:15", lyric: "不喜欢也得欣赏"},
            {time: "00:20", lyric: "我是沉默的存在"},
            {time: "00:25", lyric: "不当你世界 只作你肩膀"},
            {time: "00:29", lyric: "拒绝成长到成长"},
            {time: "00:34", lyric: "变成想要的模样"},
            {time: "00:39", lyric: "在举手投降以前"},
            {time: "00:42", lyric: "让我再陪你一段"},
            {time: "00:49", lyric: "陪你把沿路感想活出了答案"},
            {time: "00:53", lyric: "陪你把独自孤单变成了勇敢"},
            {time: "00:59", lyric: "一次次失去又重来 我没离开"},
            {time: "01:03", lyric: "陪伴是 最长情的告白"},
            {time: "01:08", lyric: "陪你把想念的酸 拥抱成温暖"},
            {time: "01:12", lyric: "陪你把彷徨 写出情节来"},
            {time: "01:18", lyric: "未来多漫长 再漫长 还有期待"},
            {time: "01:23", lyric: "陪伴你 一直到 故事给说完"},
            {time: "01:30", lyric: ""},
            {time: "01:46", lyric: "让我们静静分享"},
            {time: "01:51", lyric: "此刻难得的坦白"},
            {time: "01:56", lyric: "只是无声地交谈"},
            {time: "01:59", lyric: "都感觉幸福 感觉不孤单"},
            {time: "02:05", lyric: "陪你把沿路感想 活出了答案"},
            {time: "02:15", lyric: "一次次失去 又重来 我没离开"},
            {time: "02:20", lyric: "陪伴是 最长情的告白"},
            {time: "02:25", lyric: "陪你把想念的酸 拥抱成温暖"},
            {time: "02:29", lyric: "陪你把彷徨 写出情节来"},
            {time: "02:34", lyric: "未来多漫长 再漫长 还有期待"},
            {time: "02:39", lyric: "陪伴你 一直到 故事给说完"},
            {time: "02:48", lyric: ""},
            {time: "03:03", lyric: "陪你把沿路感想 活出了答案"},
            {time: "03:08", lyric: "陪你把独自孤单 变成了勇敢"},
            {time: "03:13", lyric: "一次次失去 又重来 我没离开"},
            {time: "03:18", lyric: "陪伴是 最长情的告白"},
            {time: "03:22", lyric: "陪你把想念的酸 拥抱成温暖"},
            {time: "03:27", lyric: "陪你把彷徨 写出情节来"},
            {time: "03:32", lyric: "未来多漫长 再漫长 还有期待"},
            {time: "03:37", lyric: "陪伴你 一直到 这故事说完"},
            {time: "03:46", lyric: ""}
        ]
